...
//			}
	...
	public void setIndicatorColorResource(Context context, int resId) {
	...
	public void setUnderlineColorResource(Context context, int resId) {
	...
	public void setDividerColorResource(Context context, int resId) {
	...
	public void setTextColorResource(Context context, int resId) {
